...
uses Classes, CastleWindow,
  ...
  ThirdPersonSnowball, Snowball, GameStateLevelSnowball3, GameStateMain;

type
  TStateLevelSnowball2 = class(TUIState)
  private
...
{ DebugSnowballs: TDebugTransform; }
    ...
    LevelNext: TStateLevelSnowball3;
...
var
  StateLevelSnowball2: TStateLevelSnowball2;
...
{ TStateLevelSnowball2 ----------------------------------------------------------------- }

constructor TStateLevelSnowball2.Create(AOwner: TComponent);
begin
  inherited;
  DesignUrl := 'castle-data:/level_snowball/gamestatelevelsnowball2.castle-user-interface';
...
procedure TStateLevelSnowball2.Start;
var
...
procedure TStateLevelSnowball2.Stop;
begin
{ FreeAndNil(Enemies); }
  inherited;
end;

procedure TStateLevelSnowball2.Update(const SecondsPassed: Single; var HandleInput: Boolean);
  var
    Enemy: TCastleScene;
    I: Integer;
    J: Integer;
...
begin
  ...
  if J = 0 then
  begin
    LevelNext := TStateLevelSnowball3.Create(Application);
...
function TStateLevelSnowball2.Press(const Event: TInputPressRelease): Boolean;
...
begin
  ...
  { This virtual method is executed when user presses
    ...
    The TStateLevelSnowball2.Press method should be used to handle keys
...
procedure TStateLevelSnowball2.ChangeCheckboxCameraFollows(Sender: TObject);
begin
  ThirdPersonNavigation.CameraFollows := CheckboxCameraFollows.Checked;
end;

procedure TStateLevelSnowball2.ChangeCheckboxAimAvatar(Sender: TObject);
begin
...
procedure TStateLevelSnowball2.ChangeCheckboxDebugAvatarColliders(Sender: TObject);
begin
  DebugAvatar.Exists := CheckboxDebugAvatarColliders.Checked;
end;

procedure TStateLevelSnowball2.ChangeCheckboxImmediatelyFixBlockedCamera(Sender: TObject);
begin
  ThirdPersonNavigation.ImmediatelyFixBlockedCamera := CheckboxImmediatelyFixBlockedCamera.Checked;
end;

procedure TStateLevelSnowball2.SpawnSnowball;
var
  Snowball: TSnowball;
begin
